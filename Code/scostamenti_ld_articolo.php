...
include_once("connessione.php");
	...
	$sql1="select cb.NrArticolo, cb.CostoTot as BCostoLD,  (cb.CostoTot/cb.QuantitaTot)*cc.QuantitaTot as Mixeff, cc.CostoTot as CCostoLD
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top" id="sideNav">
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item"><a class="nav-link js-scroll-trigger" href="scostamenti_ld_areaprod.php">Scostamento LD per Area Produzione</a></li>
                </ul>
            </div>
        </nav>';
        echo"<table class='table'>
         ...
         while($dati = $result1->fetch_assoc()) {
                      echo '<tr>
                      	...
                      	<td class="cCentrato"> '. round($dati['BCostoLD'],2).'</td>
                        <td class="cCentrato"> '. round($dati['Mixeff']-$dati['BCostoLD'],2).'</td>
						<td class="cCentrato"> '. round($dati['Mixeff'],2).'</td>
                        <td class="cCentrato"> '. round($dati['CCostoLD']-$dati['Mixeff'],2).'</td>
                        <td class="cCentrato"> '. round($dati['CCostoLD'],2).'</td>
                      </tr>';
                  }
              echo " </tbody>
              </table>";
